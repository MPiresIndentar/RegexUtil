...
import static br.indentar.com.regexutil.Objects.isNotNull;
...
public final class Strings {
     ...
     *
     * @throws AssertionError caso haja alguma tentativa de utilização deste
     * construtor.
     */
    private Strings() {
     ...
     * @param value - String analisada
     *
     * @param messageNullPointer - Mensagem utiliada na exceção.
     *
     * @param messageIllegalArgument - Mensagem utiliada na exceção.
     *
     *
     * @thows IllegalArgumentException - Caso a string seja <code>null</code> ou
     * caso a string não seja numérica.
